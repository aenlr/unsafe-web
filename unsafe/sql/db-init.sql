...
INSERT INTO post (user_id, public, likes, content)
SELECT user_id, 1, 99, 'Trump på krigsstigen igen. Very stable genius bping, bping, bping, bpong'
FROM user WHERE username = 'bosse';

INSERT INTO post (user_id, reply_to, public, content)
SELECT user_id, 4, 1, 'Good genes!'
